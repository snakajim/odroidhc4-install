...
if [ ! -f ${work_dir}/onebigfile.xml ] &&  [ ! -f ${work_dir}/armv8_isa_table.yaml ]; then 
...
if [ ! -f ${work_dir}/armv8_isa_table.yaml ]; then
  python3 ${work_dir}/extract_isa_table.py
else
  echo "You have already had armv8_isa_table.xml."
fi

echo "armv8_isa_table.yaml is successfully generated."
echo "End of program."